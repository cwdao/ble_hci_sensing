...
全阶段总览见：[`docs/achievements/method_evolution_progress_report.md`](achievements/method_evolution_progress_report.md)
...
G4-B1-v2 (8.05%)            ← b1_gating_diagnosis: 三候选最近对共识 ++ H2机制验证
    ↓
SA 自适应门控 (待验证)       ← signal_adaptive_gating: 信号级特征自适应
```
